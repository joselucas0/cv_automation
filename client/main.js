...
// DOM ELEMENTS
// ═══════════════════════════════════════════
const txtCompanyName = document.getElementById('company-name');
const txtJobTitle = document.getElementById('job-title');
const txtJobDescription = document.getElementById('job-description');
const btnGenerate = document.getElementById('btn-generate');
const btnCopy = document.getElementById('btn-copy');
const btnDownload = document.getElementById('btn-download');
const placeholderState = document.getElementById('output-placeholder');
...
const coverageWarnings = document.getElementById('coverage-warnings');
// ═══════════════════════════════════════════
// STATE MANAGERS
// ═══════════════════════════════════════════
let stepIntervalId;
...
// EVENT LISTENERS
// ═══════════════════════════════════════════
btnGenerate.addEventListener('click', () => __awaiter(void 0, void 0, void 0, function* () {
    ...
    try {
        ...
        if (!response.ok) {
            ...
            throw new Error((errData === null || errData === void 0 ? void 0 : errData.error) || `Erro do Servidor: ${response.status}`);
        }
